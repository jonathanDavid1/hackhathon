    ...
    <section className="text-gray-600 body-font relative">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-12">
          <h1 className="sm:text-4xl text-3xl font-medium title-font mb-4 text-gray-900">Contáctanos</h1>
          <p className="lg:w-2/3 mx-auto leading-relaxed text-base">¡Estamos aquí para ayudarte! Envíanos un mensaje y nos pondremos en contacto contigo lo antes posible.</p>
        </div>

      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="md:flex hidden items-center">
          <ul className="flex space-x-4">
            <li>
              <Link href="/" className='text-lavenderPurple '>Ofertas de empleo</Link>
            </li>
            <li>
              <Link href="/acercadenosotros" className='text-lavenderPurple'>Acerca de Nosotros</Link>
            </li>
            <li>
        ...
        <div className={`md:hidden ${isMenuOpen ? 'block' : 'hidden'} absolute top-16 left-0 w-full h-screen duration-300 ease-in-out bg-gray-800 z-40`}>
          <ul className="flex flex-col space-y-4 p-6">
            <li>
              <Link href="/">Ofertas de empleo</Link>
            </li>
            <li>
